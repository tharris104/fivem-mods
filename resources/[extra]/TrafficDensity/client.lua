...
local config = {
  ...
  pedFrequency        = 1.0,             -- Native ambients - Built-in frequency of PED (max value 1.0)
  trafficFrequency    = 1.0,             -- Native ambients - Built-in frequency of traffic (max value 1.0)
